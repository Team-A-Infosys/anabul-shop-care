...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .authorizeRequests().antMatchers("/signin/**","/products","/signup/buyer","/signup/seller", "/users","/products/search/name","/products/search/location","/products/search/price", "/swagger-ui/**", "/v3/api-docs/**").permitAll()
